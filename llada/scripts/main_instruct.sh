...
python run.py -t=humaneval -m=instruct -l=512 -b=32 -d=gaussian -k=4 -sc=2 -w=512 -e -re 
python run.py -t=mbpp -m=instruct -s=3 -l=512 -b=32 -d=gaussian -k=4 -sc=2 -w=128 -e -re 
...
python run.py -t=mbpp -m=instruct -s=3 -l=512 -b=32 -th=0.9 -e -d=gaussian -k=4 -sc=2 -w=128 -re 
